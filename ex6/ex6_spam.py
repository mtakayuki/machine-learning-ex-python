...
#  Yo should complete the code in emailFeatures.m to produce a feature
...
print('Number of non-zero entries: %d' % features[features > 0].sum())
...
print('Training Accuracy: %f' % ((p == y.ravel()).mean() * 100))
...
print('Test Accuracy: %f' % ((p == ytest.ravel()).mean() * 100))
...
idx = model.coef_.ravel().argsort()[::-1]
vocabList = getVocabList()

print('\nTop predictors of spam:')
print(vocabList.index[idx[0:15]], '\n')
