...
J, _ = cofiCostFunc(np.r_[X.ravel(), Theta.ravel()], Y, R,
...
def costFunc(t):
    J, _ = cofiCostFunc(t, Ynorm, R, num_users, num_movies,
                        num_features, lambda_)
    return J


def gradFunc(t):
    _, grad = cofiCostFunc(t, Ynorm, R, num_users, num_movies,
                           num_features, lambda_)
    return grad


res = minimize(costFunc, initial_parameters, jac=gradFunc,
